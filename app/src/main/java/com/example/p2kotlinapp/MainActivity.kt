...
fun MainScreen(modifier: Modifier = Modifier) {
    Box(modifier = androidx.compose.ui.Modifier.fillMaxSize()
        ...
        Button(
            ...
            Text(text = (stringResource(id = R.string.waterplant)), modifier = androidx.compose.ui.Modifier)
        }
        ...
        Button(
            ...
            Text(text = (stringResource(id = R.string.waterlevel)), modifier = androidx.compose.ui.Modifier)
        }
    }
    Column(
